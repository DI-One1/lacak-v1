...
import type { MatchLevelFilter } from "../types";
 ...
 *
 * NOTE: checkAndExpireItems() is NOT called here — this is a read-only
 * search operation. Lazy expiration happens in mutative writes only.
 */
