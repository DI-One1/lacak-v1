 ...
 *
 * NOTE: checkAndExpireItems() is NOT called here — it is only
 * invoked by mutative write operations to avoid write-on-read overhead.
 */
 ...
 * checkAndExpireItems() is called here because this function
 * is invoked from createFoundItem (a mutative write).
 */
 ...
 *
 * NOTE: checkAndExpireItems() is NOT called here — read-only operation.
 */
 ...
 * Hasilnya hanya menghasilkan notifikasi.
 * checkAndExpireItems() is called here because this function
 * is invoked from createLostReport (a mutative write).
 */
