 ...
 * Mengembalikan objek warga yang berhasil dibuat untuk sinkronisasi optimistic UI.
 */
  ...
  try {
    ...
    return {
      ...
      data: {
        id: newWarga.id,
        nama: newWarga.nama,
        peran: newWarga.peran,
        keterangan_peran: newWarga.keteranganPeran,
        nomor_telepon: newWarga.nomorTelepon,
